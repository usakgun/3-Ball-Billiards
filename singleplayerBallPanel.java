...
public class singleplayerBallPanel extends JPanel implements ActionListener, MouseListener, MouseMotionListener {
	...
	public void paint(Graphics g) {
		...
		gr2d.fill(yellow);
		gr2d.setColor(Color.BLACK);
		gr2d.drawString(mainMenu.namePlayer1 + "'s score :  " + score + "", 10, 10);
		gr2d.drawString("Ball speed " + Integer.toString((int)Math.hypot(whiteX, whiteY)), 10, 40);
		 ...
		 if(score >= 50) {
			super.paint(g);
			g.drawString("You won the game!", 500, 250);
		}
	}
